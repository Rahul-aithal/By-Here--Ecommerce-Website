  ...
  return (
    <div className='mx-2 h-full md:grid-cols-1 gap-3 relative' >
      <div className='relative my-2'>
        ...
        <h2 className='absolute right-0 top-0 mx-2 cursor-pointer text-black hover:text-blue-500' onClick={()=>{navigate("/all-items-page", { state: { bestSellers:true} })}}>See more...</h2>
      ...
      <div className='relative my-3'>
        ...
        <Button color="black" colorScheme='grey' variant={"solid"} className='font-bold mx-2    hover:shadow-xl' onClick={() => {
          ...
          <h2 className='absolute right-0 top-0 mx-2 cursor-pointer text-black hover:text-blue-500'
