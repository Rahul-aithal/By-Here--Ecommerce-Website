...
function Footer() {
  return (
    <footer className="bg-black text-white py-8 max-h-72">
      <div className="container px-8 flex flex-wrap justify-around">

        <div className="w-full md:w-1/4 mb-4">
          <h2 className="text-2xl font-bold">BuyHere</h2>
          <p>
            <div className="w-full md:w-1/4 mb-4">
        ...
        <div className="w-full md:w-1/4 mb-4">
          ...
          <ul className="mt-2">
            <li><Link to='/' href="#" className="hover:text-gray-300 ">Home</Link></li>
            <li><Link to='/about' href="#" className="hover:text-gray-300 ">About</Link></li>
            <li><Link to='/support' href="#" className="hover:text-gray-300 ">Support</Link></li>
            <li><Link to='/blogs' href="#" className="hover:text-gray-300 ">Blogs</Link></li>
          </ul>
        </div>
